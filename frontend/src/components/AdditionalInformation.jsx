...
function AdditionalInformation() {
	...
	return(
		<section id="additionalText">
			...
			<p >
				Membership is FREE of charge! <a href="mailto:cornucopia@copiarts.org">Email</a>, <a href="tel:+608-467-6646">call</a> or stop in and take a tour with us Monday-Friday 12:00-5:00 to learn more. 
			</p>
			...
			<p>
				...
				<a href="tel:+608-242-6415">Call Dane County's CCS intake at 608-242-6415</a> and ask for Cornucopia as your Service Provider! 
			</p>
			...
			<p>
				...
				<ul>
					...
					<li>Take care of each other</li>
						<ul>
							<li>
								Give assistance, if asked, or direct requests to a host, volunteer, or other resources, if you can’t
								help Speak up for others if you see something wrong Respect other people’s right to privacy and
					...
					<li>Take care of the space we share</li>
						<ul>
							<li>
								Don’t waste our supplies, use only what you need Take responsibility to clean up Help us maintain our space in good
								condition.
							</li>
						</ul>
				</ul>
